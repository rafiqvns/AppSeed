...
-(IBAction)saveButtonPressed:(id)sender {
    ...
    NSDictionary *dict = @{
        ...
        @"start_time" : self.eyeMovement.startTimes,
        @"stop_time" : self.eyeMovement.stopTimes,
        @"eye_movement" : self.eyeMovement.eyeMovement,
        @"eye_lead_counter" : self.eyeMovement.eyeLeadCounter,
        @"parked_counter" : self.eyeMovement.parkedCarsCounter,
        @"intersections_counter" : self.eyeMovement.intersectionsCounter,
        @"parked_cars_counter" : self.eyeMovement.parkedCarsCounter,
        @"predestrians_counter" : self.eyeMovement.pedestriansCounter,
        @"follow_time_counter" : self.eyeMovement.followTimeCounter,
        @"rear_counter" : self.eyeMovement.rearCounter,
        @"front_counter" : self.eyeMovement.frontCounter,
        @"gauges_counter" : self.eyeMovement.gaugesCounter,
        @"left_mirror_counter" : self.eyeMovement.leftMirrorCounter,
        @"right_mirror_counter" : self.eyeMovement.rightMirrorCounter
        
    
    };
    
    NSLog(@"EyeMovement %@", dict);
    
    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    
    NSString *url = [NSString stringWithFormat:@"students/%@/eye/", self.student.userId];
