...
@interface CSDNotesViewController : HomeBaseViewController <AddObject, UITextFieldDelegate, CSDSelectObject, UITextViewDelegate, MWPhotoBrowserDelegate, MWPhotoBrowserDelegatePlus> {
