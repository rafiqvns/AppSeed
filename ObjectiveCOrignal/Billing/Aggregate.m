...
- (RCOObject *) getObjectWithUserId: (NSString *) userId
{
    ...
    NSArray *array = [self getAllNarrowedBy: @"userId" withValue: userId sortedBy:nil];
    RCOObject *theObject = nil;
...
- (RCOObject*) getObjectWithEmail: (NSString *) email
{
    ...
    NSArray *res = [self getAllNarrowedBy: @"email" withValue:email sortedBy:nil];;
    if (res.count) {
        return [res objectAtIndex:0];
    }
    return nil;
            ...
            if ( ! [[self moc] save:&error]) {
                ...
                if( userInfo != nil && [userInfo count]) {
                    ...
                    if(detailedErrors != nil && [detailedErrors count] > 0)
                    {
                        ...
                        {
                            NSLog(@"Detail Error %@", [detailedError localizedDescription]);
                        }
                    }
                    else {
