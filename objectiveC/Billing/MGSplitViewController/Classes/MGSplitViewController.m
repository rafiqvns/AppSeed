...
#define MG_PANESPLITTER_CORNER_RADIUS	5.0		// corner-radius of split-inner corners for MGSplitViewDividerStylePaneSplitter style.
#define MG_PANESPLITTER_SPLIT_WIDTH		36.0	// width of split-gutter for MGSplitViewDividerStylePaneSplitter style.
...
- (void)setDetailViewController:(UIViewController *)detail
{
	...
	if ([_viewControllers count] > 1) {
		if ([_viewControllers objectAtIndex:1] == detail) {
            ...
            UIViewController *vc = (UIViewController *) [_viewControllers objectAtIndex:1];
