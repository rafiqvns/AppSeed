...
- (NSUInteger)numberOfLinesInLegendChartView:(JBLineChartView *)lineChartView;
@optional
...
- (UIColor *)lineChartViewColorForLineAtLineIndex:(NSUInteger)lineIndex;

- (NSString *)lineChartViewLegendTextForLineAtLineIndex:(NSUInteger)lineIndex;
