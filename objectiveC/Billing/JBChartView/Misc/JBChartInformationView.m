...
-(void)reloadData {
    [self.valueView.tableView reloadData];
}


- (id)initWithFrame:(CGRect)frame delegate:(id<UITableViewDelegate>)delegate andDataSource:(id<UITableViewDataSource>)dataSource {
    ...
    if (self)
    {
        ...
        _valueView.tableView.dataSource = dataSource;
        _valueView.tableView.delegate = delegate;
        _valueView.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _valueLabel.numberOfLines = 5;
        //self.valueLabel.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
