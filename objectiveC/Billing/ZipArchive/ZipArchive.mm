...
//	zipInfo.dosDate = (unsigned long) current;
    ...
    NSError *error = nil;
    NSString *resolvedPath = [file stringByResolvingSymlinksInPath];
	NSDictionary* attr = [[NSFileManager defaultManager] attributesOfItemAtPath:resolvedPath error:&error];
