...
class StudentInfo(admin.ModelAdmin):
    list_display = ['student', 'company', 'group', 'driver_license_number', 'driver_license_state',
...
class CompanyAdmin(admin.ModelAdmin):
    ...
    # fields = ('name', 'company_id', 'instructors', ('city', 'state'), ('zip_code', 'address'),)
...
@admin.register(StudentTestInfo)
class StudentTestInfo(admin.ModelAdmin):
    list_display = ['test', 'created']


# class StudentTestInfoAdmin(admin.ModelAdmin):
#     list_display = ['test', 'company', 'driver_license_number', 'driver_license_state',
#                     'driver_license_expire_date', 'driver_license_class',
#                     'endorsements', 'corrective_lense_required', 'created']
#
#     readonly_fields = ('created', 'updated')
#
#     autocomplete_fields = ('test', 'company', 'instructor')
#
#     search_fields = ('test__student__username', 'test__student__first_name', 'test__student__last_name',
#                      'test__student__email',
#                      'company__name', 'driver_id',
#                      'driver_license_number', 'driver_license_state',
#                      'driver_license_expire_date',
#                      'endorsements', 'corrective_lense_required',
...
#                      )
#
#     list_select_related = ('test', 'company')
#     list_filter = (
#         'driver_license_class', 'endorsements', 'corrective_lense_required',
#         'driver_license_expire_date', 'created'
#     )
...
#
#         (None, {
#             'fields': ('test', 'company', 'instructor',
#                        'created', 'updated'),
#         }),
#         (None, {
#             'fields': ('cell',)
...
class StudentTestAdmin(admin.ModelAdmin):
    list_display = ['__str__', 'student', 'instructor', 'status', 'created']
    autocomplete_fields = ['student', 'instructor']
    search_fields = ['student', 'instructor', 'status']
    list_filter = ['status']
    list_select_related = ['student', 'instructor']
...
class EquipmentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('test__student__first_name', 'test__student__last_name', 'test__student__email', 'created')
...
@admin.register(StudentTestNote)
class StudentTestNoteAdmin(admin.ModelAdmin):
    list_display = ['__str__', 'get_student_full_name', 'get_note_truncated', 'created', 'updated']
    list_select_related = ('test', 'test__student')
    search_fields = ('test__student__username', 'test__student__first_name', 'test__student__last_name', 'note')
    ...
    def get_student_full_name(self, instance):
        return instance.test.student.full_name
...
class SafeDriveEyeAdmin(admin.ModelAdmin):
    ...
    list_select_related = ('test', 'test__student',)
    search_fields = (
        'test', 'test__student__username', 'test__student__first_name', 'test__student_last_name',
        'test__student__email',
        'start_time', 'stop_time', 'eye_movement', 'eye_lead_counter', 'parked_counter',
        'intersections_counter', 'parked_cars_counter', 'predestrians_counter', 'follow_time_counter',
        'rear_counter', 'front_counter', 'gauges_counter', 'left_mirror_counter', 'right_mirror_counter',
...
class ProdItemAdminInline(admin.TabularInline):
    model = ProdItem


@admin.register(SafeDriveProd)
class SafeDriveProdAdmin(admin.ModelAdmin):
    list_display = ['test', 'date', 'department', 'miles', 'company_rep_name', 'created']
    inlines = [ProdItemAdminInline, ]
    ...
    search_fields = (
        'test__student__username', 'test__student__first_name', 'test__student__last_name', 'test__student__email',
        'date', 'department', 'miles', 'odometer', 'employee',
        'observer_first_name', 'observer_last_name')


@admin.register(ProdItem)
class ProdItemAdmin(admin.ModelAdmin):
    list_display = ['prod', 'total_number', 'location', 'trailer', 'leave_building', 'travel_path', 'speed',
                    'idle_time',
                    'plan_ahead', 'turn_around', 'on_schedule', 'customer_contact', 'not_ready_situations',
                    'brisk_pace', 'finish_work', 'created']
    autocomplete_fields = ['prod']
    list_select_related = ['prod', 'prod__test']
...
@admin.register(VehicleRoadTest)
class VehicleRoadTestAdmin(admin.ModelAdmin):
    list_display = ['test', 'date', 'miles', 'medical_card_expire_date', 'state', 'created']
    inlines = vrt_inilines

    search_fields = ('test__student__first_name', 'test__student__last_name', 'test__student__email', 'date',
...
@admin.register(PassengerVehicles)
class PassengerVehiclesAdmin(admin.ModelAdmin):
    list_display = ['test', 'date', 'start_time', 'end_time', 'company_rep_name', 'created']
    inlines = pas_inlines
