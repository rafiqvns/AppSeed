...
# 1. Pre Trip Inside Cab Class A
class PreTripInsideCabClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_insidecab_class_a')
...
# 2. Pre Trip COALS Class A
class PreTripCOALSClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_coals_class_a')
...
# 3. Pre Trip Engine Compartment Class A
class PreTripEngineCompartmentClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_engine_compartment_class_a')
...
# 4. Pre Trip Vehicle Front Class A
class PreTripVehicleFrontClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_vehicle_front_class_a')
...
# 5. Pre Trip Both Sides Vehicles Class A
class PreTripBothSidesVehiclesClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_both_sides_vehicle_class_a')
...
# 6. Pre Trip Vehicle/TractorRear Class A
class PreTripVehicleOrTractorRearClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_vehicle_or_tractor_rear_class_a')
...
# 7. Pre Trip Front or Trailer Box - Header Board Class A
class PreTripFrontTrailerBoxClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_front_trailer_box_class_a')
    ...
    electric_plug_and_air_lines = models.IntegerField(_('Electric Plug & Air Lines'), choices=NUMBER_CHOICES,
                                                      default=0, )
...
# 8. Pre Trip Driver Side Trailer Box Class A
class PreTripDriverSideTrailerBoxClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_driver_side_trailer_box_class_a')
...
# 9. Pre Trip Rear Trailer Box Class A
class PreTripRearTrailerBoxClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_rear_trailer_box_class_a')
...
# 10. Pre Trip Passenger Side Trailer or Box Class A
class PreTripPassengerSideTrailerBoxClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_passenger_side_trailer_box_class_a')
...
# 11. Pre Trip Dolly Class A
class PreTripDollyClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_dolly_class_a')

    condition = models.IntegerField(_('Condition'), choices=NUMBER_CHOICES, default=0, )
    reflectors = models.IntegerField(_('Reflectors'), choices=NUMBER_CHOICES, default=0, )
    brake_and_others = models.IntegerField(_('Brake, Tail, 4way, Signal Lights'), choices=NUMBER_CHOICES, default=0, )
    dolly_markings = models.IntegerField(_('Dolly Markings'), choices=NUMBER_CHOICES, default=0, )
    frame = models.IntegerField(_('Frame'), choices=NUMBER_CHOICES, default=0, )
...
# 12. Pre Trip PostTrip Class A
class PreTripPostTripClassA(PreTripClassMixin, models.Model):
    # relation
    pre_trip_class_a = models.OneToOneField('safe_driver.PreTripClassA', on_delete=models.CASCADE, null=False,
                                            related_name='pretrip_posttrip_class_a')
