...
# 1. Cab safety Class B
class BTWCabSafetyClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_cab_safety_class_b')
...
# 2. Start Engine ClassB
class BTWStartEngineClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_start_engine_class_b')
...
# 3. Engine Operation ClassB
class BTWEngineOperationClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_engine_operation_class_b')
...
# 4. Clutch and Transmission ClassB
class BTWClutchAndTransmissionClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_clutch_and_transmission_class_b')
...
# 5. Coupling Class B (skipped)
# 6. Uncoupling Class B (skipped)
# 7. Use of Brakes and Stopping Class B
class BTWBrakesAndStoppingsClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_brakes_and_stoppings_class_b')
...
# 8. Eye movement and mirror use Class B
class BTWEyeMovementAndMirrorClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_eye_movement_and_mirror_class_b')
...
# 9. Recognizes Hazards Class B
class BTWRecognizesHazardsClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_recognizes_hazards_class_b')
...
# 10. Lights and Signals Class B
class BTWLightsAndSignalsClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_lights_and_signals_class_b')
...
# 11. Steering Class B
class BTWSteeringClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_steering_class_b')
...
# 12. Backing Class B
class BTWBackingClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_backing_class_b')
...
# 13. Speed Class B
class BTWSpeedClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_speed_class_b')
...
# 14. Intersections Class B
class BTWIntersectionsClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_intersections_class_b')
...
# 15. Turning Class B
class BTWTurningClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_turning_class_b')
...
# 16. Parking Class B
class BTWParkingClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_parking_class_b')
...
# 17. Multiple trailers Class B (skipped)
# 18. Hills Class B
class BTWHillsClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_hills_class_b')
...
# 19. Passing Class B
class BTWPassingClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_passing_class_b')
...
# 20. General Safety and DOT adherence Class B
class BTWGeneralSafetyAndDOTAdherenceClassB(BTWClassMixin, models.Model):
    btw = models.OneToOneField('safe_driver.BTWClassB', on_delete=models.CASCADE, null=False,
                               related_name='btw_general_safety_and_dot_adherence_class_b')
