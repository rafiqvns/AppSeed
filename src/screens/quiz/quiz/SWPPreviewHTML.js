      ...
      _.forEach(level1, (level2, key) => {
        ...
        if (level2.key != 'notes') {
          ...
          if (
            ...
            // console.log('check logs: ', state[level1.key][level2.key])
            htmltableRow += `
                            <tr class="pdf-table-row-white">
                               <td colspan="6">${counterToAlpha(
                                 level2Counter,
                               )}). ${additionalText} ${
              state.instructions[key] && state.instructions[key]
            }</td>
                               </tr>`;
          } else if (
            !state.instructions[key] &&
            ...
            htmltableRow += `<tr style="border:3px solid #c4c4c4" class="">
                                      <td style="border-right:3px solid #c4c4c4">${level1Counter}${counterToAlpha(
              level2Counter,
            )}</td>
